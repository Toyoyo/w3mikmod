...
LRESULT CALLBACK fnWndProcMain(HWND hWnd, unsigned int msg, WPARAM wParam, LPARAM lParam)
{
  ...
  switch(msg)
  {
    case WM_CREATE:
    {
      ...
      tbb[3].idCommand = 2001;

      tbb[4].iBitmap = 2;
      tbb[4].fsState = TBSTATE_ENABLED;
      tbb[4].fsStyle = TBSTYLE_BUTTON;
      tbb[4].idCommand = 2002;

      tbb[5].iBitmap = 3;
      tbb[5].fsState = TBSTATE_ENABLED;
      tbb[5].fsStyle = TBSTYLE_BUTTON;
      tbb[5].idCommand = 2003;
      ...
      tbb[7].idCommand = 2004;

      tbb[8].iBitmap = 5;
      tbb[8].fsState = TBSTATE_ENABLED;
      tbb[8].fsStyle = TBSTYLE_BUTTON;
      tbb[8].idCommand = 2005;
      ...
      tbb[10].idCommand = 2006;

      tbb[11].iBitmap = 7;
      tbb[11].fsState = TBSTATE_ENABLED;
      tbb[11].fsStyle = TBSTYLE_BUTTON;
      tbb[11].idCommand = 2007;
      ...
      tbb[13].idCommand = 2008;

      ClientResize(hWnd, 320, 161);
      SendMessage(hToolbar, TB_ADDBUTTONS, sizeof(tbb)/sizeof(TBBUTTON), (LPARAM)&tbb);
      SendMessage(hToolbar, TB_AUTOSIZE, 0, 0);

      /* Our controls */
      hFileName = CreateWindowEx(0,"Static","-- FileName --", WS_CHILD|WS_VISIBLE, 0, 38, 320, 14, hWnd,(HMENU)3002,hIns,0);
      hSongName = CreateWindowEx(0,"Static","-- SongName --", WS_CHILD|WS_VISIBLE, 0, 52, 320, 14, hWnd,(HMENU)3001,hIns,0);
      hTrackerType = CreateWindowEx(0,"Static","-- Tracker Name --", WS_CHILD|WS_VISIBLE, 0, 66, 320, 14, hWnd,(HMENU)3002,hIns,0);
      CreateWindowEx(0,"Static","", WS_CHILD|WS_VISIBLE|SS_WHITERECT, 298, 97, 22, 100, hWnd,(HMENU)3004,hIns,0);
      hStatus = CreateWindowEx(0,"Static","-- Status --", WS_CHILD|WS_VISIBLE, 0, 80, 320, 16, hWnd,(HMENU)3000,hIns,0);
      hPList = CreateWindowEx(0,"Listbox","",WS_CHILD|WS_VISIBLE|LBS_HASSTRINGS|LBS_EXTENDEDSEL|LBS_NOINTEGRALHEIGHT|WS_VSCROLL,0,98,296,62,hWnd,(HMENU)3100,hIns,0);
      hPListAdd = CreateWindowEx(0,"Button","+",WS_TABSTOP|WS_CHILD|WS_VISIBLE|BS_PUSHBUTTON|BS_VCENTER,299,98,20,20,hWnd,(HMENU)3101,hIns,0);
      hPListDel = CreateWindowEx(0,"Button","-",WS_TABSTOP|WS_CHILD|WS_VISIBLE|BS_PUSHBUTTON|BS_VCENTER,299,119,20,20,hWnd,(HMENU)3102,hIns,0);
      hPListLoad = CreateWindowEx(0,"Button",">",WS_TABSTOP|WS_CHILD|WS_VISIBLE|BS_PUSHBUTTON|BS_VCENTER,299,140,20,20,hWnd,(HMENU)3103,hIns,0);
...
void SwitchSamplesBTN() {
  ...
  SendMessage(hToolbar, TB_CHANGEBITMAP, (WPARAM)2004, (LPARAM)4+5*(1-WinVisible));
...
void SwitchInstrBTN() {
  ...
  SendMessage(hToolbar, TB_CHANGEBITMAP, (WPARAM)2005, (LPARAM)5+5*(1-WinVisible));
